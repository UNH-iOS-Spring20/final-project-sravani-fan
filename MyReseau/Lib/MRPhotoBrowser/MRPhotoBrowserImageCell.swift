...
open class MRPhotoBrowserImageCell: UIView, UIScrollViewDelegate, UIGestureRecognizerDelegate, MRPhotoBrowserCell, MRPhotoBrowserZoomSupportedCell {
    ...
    /// 生成实例
    public static func generate(with browser: MRPhotoBrowser) -> Self {
    ...
    // 长按事件
    public typealias LongPressAction = (MRPhotoBrowserImageCell, UILongPressGestureRecognizer) -> Void
