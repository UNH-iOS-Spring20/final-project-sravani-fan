//
//  MRPhotoBrowserNumberPageIndicator.swift
//  MRPhotoBrowser
//
...
open class MRPhotoBrowserNumberPageIndicator: UILabel, MRPhotoBrowserPageIndicator {
    ...
    public func setup(with browser: MRPhotoBrowser) {
