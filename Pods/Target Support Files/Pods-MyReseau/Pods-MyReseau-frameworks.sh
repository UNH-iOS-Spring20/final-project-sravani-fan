...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ApplyStyleKit/ApplyStyleKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TZImagePickerControllerSwift/TZImagePickerControllerSwift.framework"
